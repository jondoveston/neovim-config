local M1 = {
  ...
  keys = {
    ...
    -- { "<C-Q>", function() Snacks.bufdelete.other() end, desc = "Delete all other buffers", },
    { "<C-b>", function() Snacks.git.blame_line() end, desc = "Blame line", },
...

    {
      ...
      function()
        Snacks.picker.buffers({
          win = { input = { keys = { ["q"] = "bufdelete" } }, list = { keys = { ["q"] = "bufdelete" } } },
        })
      end,
      desc = "Buffers",
    },
